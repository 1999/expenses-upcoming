...
export class SkladSave {
  ...
  private buildEmptyResult(objectStoresNames: string[]): {
    [storeName: string]: IDBValidKey[];
  } {
    return objectStoresNames.reduce(
      ...
      {} as { [storeName: string]: IDBValidKey[] }
    );
  }
}
